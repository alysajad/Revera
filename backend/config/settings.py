...
INSTALLED_APPS = [
    ...
    "drf_spectacular", "rest_framework_simplejwt.token_blacklist", "accounts", "leads", "analytics", "uploads", "notifications",
]
MIDDLEWARE = [
...
DATABASES = {"default": dj_database_url.config(default=f"sqlite:///{BASE_DIR / 'db.sqlite3'}", conn_max_age=int(os.environ.get("DB_CONN_MAX_AGE", "60")))}
...
CORS_ALLOWED_ORIGIN_REGEXES = [r"^https://frontend(?:-[a-z0-9-]+)?-alysajads-projects\.vercel\.app$"]
