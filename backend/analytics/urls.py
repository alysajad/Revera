...
from .views import AdminAnalyticsView, MyAnalyticsExportView, MyAnalyticsView, ReceptionistAnalyticsView, SalesManagerAnalyticsExportView, SalesManagerAnalyticsView
