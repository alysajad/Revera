...
function MonthlyBarChart({ monthly }: { monthly: ManagerAnalytics["monthly"] }) {
  ...
  const monthLabel = (value: string | null) => value ? new Intl.DateTimeFormat("en", { month: "short", year: "2-digit" }).format(new Date(value)) : "-";
