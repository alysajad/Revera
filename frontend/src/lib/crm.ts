...
type ApiSalesLead = { id: number; status: string; name: string; phone: string; source: string };
...
export type SalesLead = { id: number; status: string; statusCode: string; name: string; phone: string; source: string; sourceCode: string };
...
const toSalesLead = (lead: ApiSalesLead): SalesLead => ({ id: lead.id, name: lead.name, phone: lead.phone, source: sourceName(lead.source), sourceCode: lead.source, statusCode: lead.status, status: statusName(lead.status) });
